...
CREATE TABLE aura.aggregated_user_daily_data_temp
(
    `user_uid` String,
    `tkn_uuid` UUID,
    `day` Date,
...
INSERT INTO aura.aggregated_user_daily_data_temp
SELECT
    user_uid,
    tkn_uuid,
    day,
...
RENAME TABLE aura.aggregated_user_daily_data_temp TO aura.aggregated_user_daily_data;
